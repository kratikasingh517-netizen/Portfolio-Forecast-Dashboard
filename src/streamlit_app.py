...
def run_dashboard() -> None:
    # Add logo to sidebar
    try:
        st.logo("assets/techiehelp_logo.png", icon_image="assets/techiehelp_logo.png")
    except Exception:
        pass  # Gracefully handle if logo file is missing
    
    # Add logo to main page header
    col1, col2 = st.columns([1, 5])
    with col1:
        try:
            st.image("assets/techiehelp_logo.png", width=100)
        except Exception:
            pass  # Gracefully handle if logo file is missing
    with col2:
